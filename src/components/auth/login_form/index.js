            ...
            <Column.Group centered>
                <form onSubmit={HandleSubmit}>
                    <Column size={12}>
                        ...
                        <Field>
                            <Control>
                                <Column.Group breakpoint="mobile">
                                    <Column>
                                        <a className="button is-white has-text-custom-purple" onClick={e => setRedirectToRegister(true)}>Register ou</a>
                                    </Column>
                                    <Column>
                        ...
                        {error && <Help color="danger">E-mail ou senhas inválidas!</Help>}
                    </Column>
                </form>
            </Column.Group>
        </Fragment>
